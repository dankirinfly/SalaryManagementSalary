        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3"> 
                   ...
                   <div class="panel panel-default"> 
                    ...
                    <div class="list-group"> 
                     ...
                     <a class="list-group-item  active" href="${pageContext.request.contextPath }/admin/forms3.action"><i class="fa fa-fw fa-gear"></i> お知らせ入力 </a>
                    </div> 
                   </div> 
                   <div class="panel panel-default"> 
                    <div class="panel-heading">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                    <form method="post" action="${pageContext.request.contextPath }/admin/gonggao.action" class="form-horizontal">
                        <div class="panel panel-default">
                            ...
                            <div class="bootstrap-admin-panel-content">
                            	<div  >
                            		...
                            		<div  >
                            		<input id = "gonggao"  type="date" name="gonggaodate" />
                            	</div>
                            	<div  >
                            		<label >お知らせの概要</label>
                            		</div>
                            		<div  >
                            		<input type="text" class="col-lg-12"name="gonggaotitle" >
                            	</div>
                            	<div >
                            		<label >お知らせの内容</label>
                            		</div>
