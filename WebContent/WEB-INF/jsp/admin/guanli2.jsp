    ...
    <head>
        ...
        <script type="text/javascript">
        	...
        	function detailChange(id){
        		 var path = "${pageContext.request.contextPath }/admin/detailChange.action";    
        		 var $traffic=$('<input type="hidden" name="detailid" />');
           		 $traffic.attr("value", id);
           		 $('#detailForm').append($traffic);
           		 $('#detailForm').attr("action", path).submit(); 
        	}
        	function detailDeleate(id){
        		 var path = "${pageContext.request.contextPath }/admin/detailDeleate.action";    
        		 var $traffic=$('<input type="hidden" name="detailid" />');
           		 $traffic.attr("value", id);
           		 $('#detailForm').append($traffic);
           		 $('#detailForm').attr("action", path).submit(); 
                ...
                <!-- left, vertical navbar -->
                   ...
                   <div class="panel panel-default"> 
                    ...
                    <div class="list-group"> 
                     ...
                     <a class="list-group-item   active" href="${pageContext.request.contextPath }/admin/guanli2.action"><i class="fa fa-fw fa-lock"></i> 社員給与 </a>
                                ...
                                <table class="table table-striped table-bordered" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA">
                                           ...
                                           <td><button type="button" onclick="detailChange(${detail.detailid })">修正</button></td>
                                           <td><button type="button" onclick="detailDeleate(${detail.detailid })">削除</button></td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
