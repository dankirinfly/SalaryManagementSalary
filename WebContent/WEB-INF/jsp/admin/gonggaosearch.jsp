        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                    <form method="post" action="${pageContext.request.contextPath }/admin/admin.action" class="form-horizontal">
                        <div class="panel panel-default">
                            ...
                            <div class="bootstrap-admin-panel-content">
                            	...
                            	<div  >
                            		...
                            		<div  >
                            		<input type="text" readonly="readonly" class="col-lg-12"value="${ gonggao.gonggaotitle  }" >
                            	</div>
                            	<div >
                            		<label >公告の内容</label>
                            		</div>
