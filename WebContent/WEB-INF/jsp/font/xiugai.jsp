...
<html>
    <head>
       ...
       function employeetijiao(){
   			var path = "${pageContext.request.contextPath }/font/employeexiugai.action";
   			$('#employeeForm').attr("action", path).submit();    		     
   		}
   		function employeequxiao(){
   			var path = "${pageContext.request.contextPath }/font/xiugai.action";
   			$('#employeeForm').attr("action", path).submit();	
   		}
            ...
            <div class="row">
                <!-- left, vertical navbar -->
                   ...
                   <div class="panel panel-default"> 
                    ...
                    <div class="list-group"> 
                     <a class="list-group-item active" href="${pageContext.request.contextPath }/font/xiugai.action"><i class="fa fa-fw fa-gear"></i> 個人情報修正 </a>
                    </div> 
                   </div> 
                   <div class="panel panel-default"> 
                    <div class="panel-heading">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                     <form id="employeeForm" method="post" action="" class="form-horizontal">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">個人情報修正</div>
                            </div>
                                ...
                                <table class="table table-striped table-bordered" id="">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA">
                                            ...
                                            <td><input class="col-lg-12" type="date" name="employeeregisteredtime"  readonly="readonly"  value = "${fn:substring(employee.employeeregisteredtime, 0, 10)}"/></td>
                                        </tr>
